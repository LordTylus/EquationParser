...
class ParenthesisParserTest {
    ...
    void parses(String equation, String expected) {
        ...
        Equation actual = ParenthesisParser.DEFAULT.parse(equation, register).orElseThrow();
    ...
    void doesNotParse(String equation) {
        ...
        Optional<? extends Equation> actual = ParenthesisParser.DEFAULT.parse(equation, register);
